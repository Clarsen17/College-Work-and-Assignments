...
void arraySubsetCopy(double source[], int source_size, double destination[], int dest_size, int num_to_copy) 
{
    int copy_count = min(min(source_size, dest_size), num_to_copy);
