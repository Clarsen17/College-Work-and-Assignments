...
//* Method that divides two fractional values and returns the result
Fraction Fraction::divide(int divNumerator, int divDenominator)
{
    
    Fraction result(numerator * divDenominator, denominator * divNumerator);
    result.reduce();
    return result;
}
...
{
    return divide(divValue.numerator, divValue.denominator);
}
